...
def combination_test(stock, df, comboList, chunk_size, first_monday, last_monday, threshold, mId):
	...
	'''
	if mId == 1 and threshold == 0.5:
		SQL_df.to_csv('tailexample.csv')
	'''
...
def main():
	...
	candidatesTime = ['ADX', 'RSI', 'lowerb', 'MA', 'PPO', 'TSF', 'WMA', 'ADXR', 'MFI', 'NATR', 'WILLR', 'ROCR100', 'TRIX']
	#Set time ranges
	timeRange = [5, 30, 60, 120, 390, 1950]
	#For internal operations
	analysisFlags = ['/', '-']
	#means internal testing only (ex: RSI_60/RSI_120, but no RSI_60 and RSI_120 seperate)
	internalOnly = ['TRIX', 'TSF', 'ADXR', 'MA', 'WMA']
	#Specific features only?
	specificFeatures = [['PPO_5', 'ADXR_5/ADXR_60', 'lowerb_1950', 'MA_5/MA_390'], ['NATR_30', 'WILLR_30', 'RSI_390'], ['NATR_30', 'WILLR_30', 'PPO_5', 'RSI_390'], ['lowerb_1950', 'PPO_5', 'ROCR100_60'], 
	['lowerb_1950','PPO_5','MA_5/MA_390'], ['lowerb_1950','MA_5/MA_390','PPO_5'], ['PPO_5','NATR_30','MA_5/MA_390'], ['MA_5/MA_390','NATR_30','PPO_5'], ['WMA_30/WMA_390','NATR_30','PPO_5'], 
	['RSI_390','NATR_30','TRIX_5-TRIX_390'], ['PPO_5','NATR_30','WMA_30/WMA_390'], ['MA_5/MA_390','NATR_30','ADX_120'], ['lowerb_1950','PPO_5','TSF_5-TSF_390'], ['PPO_5','ADXR_5/ADXR_60','MA_5/MA_390','NATR_30'], 
	['PPO_5','RSI_390','lowerb_1950','MA_5/MA_390'], ['WMA_30/WMA_390','NATR_60','PPO_5','RSI_390'], ['TSF_30/TSF_390','NATR_30','PPO_5','ADXR_5/ADXR_60'], ['MA_5/MA_390','NATR_30','TRIX_5-TRIX_390'], 
	['MFI_5','NATR_30','PPO_5','WMA_30/WMA_390'], ['PPO_5','WMA_30/WMA_390','MA_5/MA_390','NATR_30'], ['PPO_5','NATR_30','lowerb_1950','MA_5/MA_390'], ['ADX_30','NATR_60','PPO_5'], 
	['PPO_5','NATR_60','ADX_30'], ['MA_5/MA_390','NATR_30','lowerb_1950','PPO_5'], ['PPO_5','TSF_30/TSF_390','TSF_5-TSF_390'], ['MFI_5','NATR_30','PPO_5','RSI_390'], 
	['PPO_5','TSF_30/TSF_390','MFI_5','NATR_30'], ['PPO_5','RSI_390','lowerb_1950'], ['ADX_30','ADXR_5/ADXR_60']]
	...
	feature_combinations += combinations(candidates, 1)
